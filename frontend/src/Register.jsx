    ...
    <div style={{ width: "100%", maxWidth: "400px" }}>
      ...
      >
        <div style={{ borderBottom: "1px solid var(--border)", paddingBottom: "12px", marginBottom: "4px" }}>
          ...
          <span className="meta" style={{ fontSize: "12px" }}>Join communities, craft quilts, and debate records</span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          <label className="meta" style={{ fontSize: "11px" }}>HANDLE / USERNAME</label>
          <input
            type="text"
            placeholder="e.g. vinyljunkie"
            value={username}
      ...
      <div style={{ textAlign: "center", marginTop: "20px" }}>
        <button
          ...
          style={{ fontSize: "13px" }}
        >
          Already have an account? <span style={{ color: "var(--mustard)", textDecoration: "underline", marginLeft: "4px" }}>Sign in</span>
        </button>
      </div>
    </div>
  );
