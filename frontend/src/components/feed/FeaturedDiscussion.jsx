    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-surface-sunken/80">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1 font-mono text-[9px] font-bold uppercase tracking-widest px-1.5 py-0.5 rounded-[3px] bg-accent text-accent-text">
            <Flame className="w-2.5 h-2.5 fill-accent-text" />
            FEATURED
          </span>
        ...
        <div className="md:col-span-7 flex flex-col justify-between space-y-3">
          ...
          <div className="pt-3 border-t border-border flex items-center justify-between gap-3 flex-wrap">
            <button
              type="button"
              onClick={() => onSelectThread?.(thread)}
              className="h-8 px-3.5 rounded-md bg-accent text-accent-text hover:bg-accent-hover font-heading font-bold text-xs tracking-tight transition-all active:translate-y-px cursor-pointer flex items-center gap-1.5 shadow-1"
            >
