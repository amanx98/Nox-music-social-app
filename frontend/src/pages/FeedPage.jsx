    ...
    <div className="w-full max-w-[1440px] mx-auto space-y-6 text-left">
            ...
            <div className="flex items-center justify-between gap-3 pb-2 border-b border-border">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 h-7 px-3 rounded-md bg-accent text-black hover:bg-accent-hover hover:text-black font-heading font-bold text-xs tracking-tight transition-all active:translate-y-px cursor-pointer shadow-1"
                >
              ...
              {loading ? (
                ...
                <div className="p-10 text-center flex flex-col items-center justify-center">
                  ...
                  <button
                    type="button"
                    onClick={handleOpenComposer}
                    className="h-8 px-4 rounded-md bg-accent text-black hover:bg-accent-hover hover:text-black font-heading font-bold text-xs transition-all active:translate-y-px cursor-pointer"
                  >
                    Transmit First Take
                  </button>
                </div>
      ...
      <div className="sm:hidden fixed bottom-6 right-6 z-40">
        <button
          type="button"
          onClick={handleOpenComposer}
          className="w-12 h-12 rounded-md bg-accent text-black hover:bg-accent-hover hover:text-black shadow-5 flex items-center justify-center transition-transform active:scale-95 cursor-pointer"
