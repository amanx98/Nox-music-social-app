      ...
      <div className="rounded-md border border-border bg-surface-raised p-5 space-y-3 shadow-1">
        ...
        <form onSubmit={handleCreateTag} className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="h-9 px-4 rounded-md bg-accent text-accent-text hover:bg-accent-hover font-heading font-bold text-xs tracking-tight transition-all disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer flex items-center gap-1.5"
          >
